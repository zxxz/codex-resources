...
<domain_expertise>
**Domain expertise lives in `~/.codex/skills/expertise/`**
...
```bash
cat ~/.codex/skills/expertise/[domain]/SKILL.md 2>/dev/null
```
...
cat ~/.codex/skills/expertise/macos-apps/references/core-data.md
cat ~/.codex/skills/expertise/macos-apps/references/swift-conventions.md
```
