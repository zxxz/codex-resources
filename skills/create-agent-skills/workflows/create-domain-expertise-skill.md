...
Explain:
```
Domain expertise skills go in: $CODEX_HOME/skills/expertise/{domain-name}/
...
Location: $CODEX_HOME/skills/expertise/{suggested-name}/
```
...
```bash
# Create structure
mkdir -p $CODEX_HOME/skills/expertise/{domain-name}
mkdir -p $CODEX_HOME/skills/expertise/{domain-name}/workflows
mkdir -p $CODEX_HOME/skills/expertise/{domain-name}/references
...
# Verify structure
ls -R $CODEX_HOME/skills/expertise/{domain-name}
```

## Step 11: Document in create-plans

Update `$CODEX_HOME/skills/create-plans/SKILL.md` to reference this new domain:
...
- [ ] Platform-specific considerations included
- [ ] Located in $CODEX_HOME/skills/expertise/{domain-name}/
